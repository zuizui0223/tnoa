...
The final decision vocabulary includes U whenever the current evidence does not justify a unique target/nuisance inference.
...
> The phase-surface conclusions are prior-free or invariant to arbitrary ecological prevalence weighting.
